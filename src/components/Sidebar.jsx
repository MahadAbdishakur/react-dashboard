...
import { SelectionCharacterFormat } from '@syncfusion/ej2/documenteditor';
...
const Sidebar = () => {
  ...
  return (
    ...
    md:hover:overflow-auto pb-10 bg-red-600">
      {activeMenu && (<>
        ...
        <div className="mt-10">
          { links.map((item) =>(
            <div key={item.title}>
              <p className="text-yellow-400 m-3 mt-4 uppercase">
              {item.title}
              </p>
              {item.links.map((Link) => (
                <NavLink
